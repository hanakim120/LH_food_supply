...
def train_extratree(train_df,
    ...
    reg_dinner = ExtraTreesRegressor(
        n_estimators=config.n_est,
        criterion='mae',
        max_depth=config.depth if config.depth > 0 else None,
        min_samples_split=2,
...
def train_gradient_boosting(
    ...
    reg_lunch = GradientBoostingRegressor(
        n_estimators=config.n_est,
        subsample=config.rsm,
        criterion='mae',
        max_depth=config.depth if config.depth > 0 else None,
        min_samples_split=2,
        min_samples_leaf=config.min_samp,
    ...
    reg_dinner = GradientBoostingRegressor(
        n_estimators=config.n_est,
        subsample=config.rsm,
        criterion='mae',
        max_depth=config.depth if config.depth > 0 else None,
...
def train_decision_tree(
    ...
    reg_lunch = DecisionTreeRegressor(
        criterion='mae',
        max_depth=config.depth if config.depth > 0 else None,
        min_samples_split=2,
        min_samples_leaf=config.min_samp,
    ...
    reg_dinner = DecisionTreeRegressor(
        criterion='mae',
        max_depth=config.depth if config.depth > 0 else None,
        min_samples_split=2,
        min_samples_leaf=config.min_samp,
